...
public class ConnectionInformation {
	...
	/**
	 * Constructs a ConnectionInformation instance with the given initial values.
	 * 
	 * @param host
	 ...
	 * 
	 * @return Returns true, if the object has all information required to connect
	 *         to a MySQL database. Returns false otherwise.
	 */
	public boolean isComplete() {
		 ...
		 */
		return (null != db_host) && !db_host.isEmpty() && (null != db_name) && !db_name.isEmpty() && (null != db_user)
				&& !db_user.isEmpty() && (db_port > 0) && (db_port < 65536);
	}
