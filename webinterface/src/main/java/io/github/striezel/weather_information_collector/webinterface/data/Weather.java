...
public class Weather {
	...
	/**
	 * Checks whether this instance has time when the data was received / measured.
	 * 
	 ...
	 * 
	 * @return Returns the temperature in °C. Returns NaN, if no temperature is set
	 *         for that unit.
	 */
	 ...
	 * 
	 * @return Returns true, if the instance has humidity information. Returns false
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return Returns the relative humidity in percent. Returns -1, if no humidity
	 *         is set.
	 */
	public int humidity() {
		return humidity;
